...
// getIssue retrieves an issue by ID within a project-scoped route, with optional
// detailed view including dependencies, labels, and comments when details=true is specified.
