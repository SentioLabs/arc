...
**Without `epic-id`:** Read all ready issues with `teammate:*` labels in active project.
...
`/teams` (or `/projects/:id/teams`)

### API Endpoint

```
GET /api/v1/projects/{ws}/team-context?epic_id=PROJ-5
```
