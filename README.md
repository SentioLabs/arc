...
`v0.16.0-rc.1`, `v0.16.0-rc.2`. Arc also compares legacy counters numerically:
`rc9` sorts below `rc10`, and `rc10` compares equal to `rc.10`. The original
release tag is preserved for downloads. Older Arc binaries may need a one-time
